...
бильярд где шары могут притягиваться/отталкиваться или бильярд со крайне тяжелыми шарами (возможно с планетами солнечной системы, тогда это 9-ball)
 ...
 т.к. у меня проблемы с отладкой и я не могу понять кто портит данные (EXTERN C или я), то временно добавлен main.cc
 ---
шаг 1. написать обычную 9-ball версию, соответственно:
---
...
---
а нужна ли мне позиция объектов если их скорость я задаю векторами? 

---
шаг 2 - узнать а стоит ли использовать readme для планирования шагов (вроде можно)
---
